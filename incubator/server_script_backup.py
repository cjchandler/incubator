...
def parse_incoming_texts():
    ...
    TWILIO_ACCOUNT_SID = "ACb6bf6fb3067e1eed66ab3fc6d99c3919"
    TWILIO_AUTH_TOKEN = "8dca958356a83feb5699097ac2324dd7"
    twilio_api = Client(TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN)
    client = Client(TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN)
...
class server_monitor:
    def __init__(self , today_filename, doturnalarms):
        ...
        self.df_prev = pd.read_csv("./incubator_daily/incubator_daily/"+ self.today_filename)
