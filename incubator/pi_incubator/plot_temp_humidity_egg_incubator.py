...
df = pd.read_csv( path + "2026-07-31_state"+ v+".csv")
...
final_df = final_df[["temperature_1_C" ,"temperature_2_C" , "humidity_1" , "heater_on","target_temperature", 'front_turn_switch', 'rear_turn_switch', 'top_switch']].copy()
