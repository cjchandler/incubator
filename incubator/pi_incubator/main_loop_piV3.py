...
# Initialize the temperature humidity co2 sensors
...
def init_state_dict():
    ...
    state_dict['target_humidity'] = 0.58
    state_dict['range_humidity'] = 0.01 #can be plus or minus this before we try to fix it  
