...
alarm_unit = server_monitor( "today_dataV2.csv" , False , "/home/cjchandler/Git_Projects/last_update_repo/" , "incubator_v2.txt") #server monitor with turning checking
