...
df = pd.read_csv( path + "2026-08-05_state"+ v+".csv")
...
final_df = final_df[["temperature_2_C" , "humidity_2","temperature_1_C" , "humidity_1","near_switch" , "heater_on","target_temperature",  "far_switch"]].copy()
